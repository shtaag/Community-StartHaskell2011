...
｛以下｝｛いか｝は｛第｝｛だい｝8｛章｝｛しょう｝のパーサー（ページ101～102）
だ。
...
do｛記法｝｛きほう｝を｛使｝｛つか｝えず、｛上｝｛うえ｝のパーサー
｛関数｝｛かんすう｝を｛再定義｝｛さいていぎ｝せよ。`>>=`と`>>`の
｛関数｝｛かんすう｝を｛直接｝｛ちょくせつ｝｛使｝｛つか｝う
｛必要｝｛ひつよう｝になる。`+++`の｛演算子｝｛えんざんし｝を
｛使｝｛つか｝って｛良｝｛よ｝い。｛各｝｛かく｝｛変数｝｛へんすう｝の
スコープを｛明｝｛あき｝らかにするために｛沢山｝｛たくさん｝
｛括弧｝｛かっこ｝を｛使｝｛つか｝って｛良｝｛よ｝い。
...
do｛記法｝｛きほう｝と`+++`｛演算子｝｛えんざんし｝を｛使｝｛つか｝えず、また
パーサー｛関数｝｛かんすう｝を｛再定義｝｛さいていぎ｝せよ。
｛今回｝｛こんかい｝、`Parser`のコンストラクター（`P`）を
｛直接｝｛ちょくせつ｝｛使｝｛つか｝う｛必要｝｛ひつよう｝になる。
...
モナド｛関数｝｛かんすう｝（`>>=`、`>>=`、`return`）を｛使｝｛つか｝えず、また
パーサー｛関数｝｛かんすう｝を｛再定義｝｛さいていぎ｝せよ。
