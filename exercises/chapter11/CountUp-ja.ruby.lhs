...
｛書｝｛か｝かれている。このファイルを｛自分｝｛じぶん｝のパソコンにダウンロード
して、`CountUp.lhs`と｛名付｝｛なづ｝けよ。ファイルにある`undefined`
｛関数｝｛かんすう｝を｛消｝｛け｝して、｛自分｝｛じぶん｝の
｛定義｝｛ていぎ｝で｛実装｝｛じっそう｝せよ。｛含｝｛ふく｝まれているテストで
｛自分｝｛じぶん｝の｛定義｝｛ていぎ｝を｛確認｝｛かくにん｝せよ。
｛全｝｛すべ｝てのテストが｛通｝｛かよ｝ったら、ゲームをコンパイルして
｛遊｝｛あそ｝ぶことができるようになる。
...
「｛数｝｛かぞ｝え｛上｝｛あ｝げ」ゲームは、｛昔｝｛むかし｝、
｛私｝｛わたし｝がMixiの｛数学｝｛すうがく｝コミュニティーで｛遊｝｛あそ｝んだ
ゲームだ。プレーヤーは、ある｛決｝｛き｝まった｛数字｝｛すうじ｝の
｛集合｝｛しゅうごう｝（｛大体｝｛だいたい｝｛現在｝｛げんざい｝の
｛年月日｝｛ねんがっぴ｝）と｛演算子｝｛えんざんし｝を｛使｝｛つか｝って、
｛目標｝｛もくひょう｝の｛値｝｛あたい｝になる｛関数｝｛かんすう｝を
｛作｝｛つく｝る。｛各｝｛かく｝｛関数｝｛かんすう｝は｛全｝｛すべ｝ての
｛数字｝｛すうじ｝をちょうど｛一回｝｛いっかい｝ずつ｛使｝｛つか｝う
｛必要｝｛ひつよう｝がある。｛目標｝｛もくひょう｝の｛値｝｛あたい｝は0から
｛始｝｛はじ｝まり、｛正当｝｛せいとう｝な｛関数｝｛かんすう｝を
｛見｝｛み｝つかったら｛増加｝｛ぞうか｝させていく。

｛例｝｛れい｝：｛数字｝｛すうじ｝が`20111116`で、｛目標｝｛もくひょう｝の
｛値｝｛あたい｝が`121`だったら、`(20-(6+1+1+1))^(1+1)`が
｛正当｝｛せいとう｝な｛関数｝｛かんすう｝だ。

この｛練習｝｛れんしゅう｝｛問題｝｛もんだい｝では、Haskellでこのゲームを
｛開発｝｛かいはつ｝する。

｛次｝｛つぎ｝のモジュール｛宣言｝｛せんげん｝とインポートは
｛無視｝｛むし｝して｛良｝｛よ｝い。
...
｛同｝｛おな｝じ｛構文木｝｛こうぶんぎ｝を｛持｝｛も｝っていたら
｛同等｝｛どうとう｝だ。｛例｝｛たと｝えば、`(1 + 2) + 3`と`1 + (2 + 3)`は
｛構文木｝｛こうぶんぎ｝が｛異｝｛こと｝なるので｛同等｝｛どうとう｝ではない。
...
｛場合｝｛ばあい｝を｛除｝｛のぞ｝いて、｛必｝｛かなら｝ず｛括弧｝｛かっこ｝を
｛付｝｛つ｝けよ。

    * ｛関数｝｛かんすう｝｛全体｝｛ぜんたい｝には｛括弧｝｛かっこ｝は
      ｛必要｝｛ひつよう｝ない
    * ｛絶対値｝｛ぜったいち｝の｛中｝｛なか｝の｛関数｝｛かんすう｝には
      ｛括弧｝｛かっこ｝は｛必要｝｛ひつよう｝ない
...
｛実装｝｛じっそう｝では｛明示的｝｛めいじてき｝に｛括弧｝｛かっこ｝を
｛使｝｛つか｝うが、このパーサーは｛括弧｝｛かっこ｝がない
｛関数｝｛かんすう｝を｛取｝｛と｝り｛込｝｛こ｝める｛必要｝｛ひつよう｝が
ある。｛以下｝｛いか｝の｛結合性｝｛けつごうせい｝と｛束縛｝｛そくばく｝の
｛優先順位｝｛ゆうせんじゅんい｝を｛使｝｛つか｝え。
...
｛返｝｛かえ｝す｛関数｝｛かんすう｝`digits`を｛定義｝｛ていぎ｝せよ。
`12`という｛値｝｛あたい｝は｛二｝｛ふた｝つの｛数字｝｛すうじ｝（`1`と`2`）を
｛使｝｛つか｝っていることに｛注意｝｛ちゅうい｝せよ。
｛戻｝｛もど｝り｛値｝｛ち｝は｛昇順｝｛しょうじゅん｝のリストとする。
`Data.List`からインポートされた`sort :: Ord a => [a] -> [a]`
...
｛使｝｛つか｝って｛値｝｛あたい｝を｛返｝｛かえ｝せ。｛以下｝｛いか｝の
｛場合｝｛ばあい｝は`Nothing`を｛返｝｛かえ｝せ。

    * ｛評価｝｛ひょうか｝する｛値｝｛あたい｝が｛整数｝｛せいすう｝ではない
    * 0によるの｛除算｝｛じょざん｝やモジュロ
    * マイナスの｛階乗｝｛かいじょう｝

`Maybe`はモナドのインスタンスだから、do｛記法｝｛きほう｝を｛使｝｛つか｝って
`eval`を｛定義｝｛ていぎ｝できる。こういう`Maybe`の
｛使｝｛つか｝い｛方｝｛かた｝は｛本｝｛ほん｝には｛書｝｛か｝いてない。
｛最初｝｛さいしょ｝にdo｛記法｝｛きほう｝を｛使｝｛つか｝わずに`eval`を
｛普通｝｛ふつう｝に｛定義｝｛ていぎ｝することをお｛勧｝｛すす｝めする。
この｛定義｝｛ていぎ｝が｛全｝｛すべ｝てのテストを｛通｝｛かよ｝ったら
do｛記法｝｛きほう｝を｛使｝｛つか｝ってみると｛良｝｛よ｝い。
...
｛定義｝｛ていぎ｝せよ。｛最初｝｛さいしょ｝の｛引数｝｛ひきすう｝は
`String`｛型｝｛かた｝の｛数字｝｛すうじ｝のリストだ。｛二番目｝｛にばんめ｝の
｛引数｝｛ひきすう｝は｛現在｝｛げんざい｝の｛目標｝｛もくひょう｝の
｛値｝｛あたい｝だ。この｛関数｝｛かんすう｝は`IO`モナドに
｛入｝｛はい｝っているので、｛画面｝｛がめん｝に｛文字列｝｛もじれつ｝を
｛表示｝｛ひょうじ｝するために`putStrLn`｛関数｝｛かんすう｝を
｛使｝｛つか｝ったり、プレーヤーが｛入力｝｛にゅうりょく｝した
｛文字列｝｛もじれつ｝を｛受｝｛う｝け｛取｝｛と｝るために`getLine`
｛関数｝｛かんすう｝を｛使｝｛つか｝ったりすることができる。

プレーヤーに｛数字｝｛すうじ｝と｛現在｝｛げんざい｝の｛目標｝｛もくひょう｝の
｛値｝｛あたい｝が｛分｝｛わ｝かるように、この｛関数｝｛かんすう｝は
｛最初｝｛さいしょ｝にプロンプトを｛表示｝｛ひょうじ｝する。
｛例｝｛たと｝えば、｛数字｝｛すうじ｝が`20111116`で｛現在｝｛げんざい｝の
...
ように、`putStr`でプロンプトを｛表示｝｛ひょうじ｝して｛後｝｛あと｝
`hFlush stdout`を｛実行｝｛じっこう｝する。それから`getLine`を
｛使｝｛つか｝って、｛入力｝｛にゅうりょく｝した｛文字列｝｛もじれつ｝を
｛受｝｛う｝け｛取｝｛と｝る。

プレーヤーが「quit」を｛入力｝｛にゅうりょく｝したら｛止｝｛と｝める。
...
この｛実装｝｛じっそう｝の｛問題｝｛もんだい｝は、`getLine`では
｛入力｝｛にゅうりょく｝｛時｝｛じ｝に｛編集｝｛へんしゅう｝することが
できない｛点｝｛てん｝だ。｛例｝｛たと｝えば、｛括弧｝｛かっこ｝を
｛忘｝｛わす｝れても｛戻｝｛もど｝って｛入力｝｛にゅうりょく｝しなおすことが
できない。これはとても｛面倒｝｛めんどう｝だ。

｛入力｝｛にゅうりょく｝する｛時｝｛とき｝に｛編集｝｛へんしゅう｝できる
ように、｛私｝｛わたし｝がhaskelineライブラリを｛使｝｛つか｝って
｛他｝｛ほか｝の`play`｛関数｝｛かんすう｝を｛定義｝｛ていぎ｝した。この
ファイルの｛全｝｛すべ｝てのテストを｛通｝｛かよ｝ったら、`main`
